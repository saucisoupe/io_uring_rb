Ring buffer manager for io_uring in *core-per-thread architecture context*, works along with the io-uring crate.
...
# precautions to take
- Buffers are not automatically recycled on drop, feel free to implement your own freeing logic
